...
public class MarcaDetallesDlg extends javax.swing.JDialog {
    
    Marca marca;

    public MarcaDetallesDlg(java.awt.Frame parent, boolean modal, Marca marca) {
        super(parent, modal);
        initComponents();
        this.marca = marca;
        cargarTabla();
        
        jLabel3.setText(marca.getCódigo());
        jLabel4.setText(marca.getNombre());
        cargarTabla();
    }
