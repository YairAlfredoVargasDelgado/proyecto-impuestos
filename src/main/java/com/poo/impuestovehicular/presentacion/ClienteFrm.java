...
public class ClienteFrm extends javax.swing.JFrame {
    ...
    public ClienteFrm(Cliente cliente) {
        ...
        infoLbl.setText(cliente.getNombres() + " " + cliente.getPrimerApellido() + " " + cliente.getSegundoApellido() + " - " + cliente.getIdentificación());
        cargarVehículosTbl();
    }
    ...
    private void initComponents() {
        ...
        infoLbl.setText("Nombre completo");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new VehículosDlg(null, true, cliente).setVisible(true);
